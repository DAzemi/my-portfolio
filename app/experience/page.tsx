    ...
    <section className="relative min-h-screen bg-gradient-to-r from-blue-500 to-purple-600 text-white text-center px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="space-y-12 pb-12">
          <div className="bg-gray-900 p-6 rounded-lg shadow-lg flex flex-col sm:flex-row justify-between items-center sm:items-start">
            ...
            <ul className="mt-4 space-y-2 text-gray-300 text-lg sm:text-base w-full sm:w-2/3">
